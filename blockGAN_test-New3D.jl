...
#     h2_pool = h2_fg
    ...
    h2_pool = transform_voxel_to_match_image(h2_pool)
...
zdim2 = 60
imsize = 64
skew_matrix = compute_skew_matrix_nearFar(bs, 16, 16; focal_length=35, sensor_size=32, distance = 10);
